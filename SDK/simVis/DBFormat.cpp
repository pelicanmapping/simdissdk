...
void DBImageLayer::Options::fromConfig(const Config& conf)
{
...
void DBImageLayer::setDeepestLevel(const unsigned& value)
{
  options().driver()->deepestLevel() = value;
}

const unsigned& DBImageLayer::getDeepestLevel() const
{
  return options().driver()->deepestLevel().get();
}

osgEarth::TileSource*
DBImageLayer::createTileSource()
{
...
void DBElevationLayer::Options::fromConfig(const Config& conf)
{
  driver() = simVis::DBOptions(conf);
}
...
void DBElevationLayer::setDeepestLevel(const unsigned& value)
{
  options().driver()->deepestLevel() = value;
}

const unsigned& DBElevationLayer::getDeepestLevel() const
{
  return options().driver()->deepestLevel().get();
}

osgEarth::TileSource*
DBElevationLayer::createTileSource()
{
  return osgEarth::TileSourceFactory::create(options().driver().get());
}
